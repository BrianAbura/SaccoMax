                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">Edit Incomes </li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            @endif
                            {{-- Alerts for the home page --}}
                            <form class="row g-3" method="POST" action="{{ route('incomes.update', $income->id) }}"
                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <input class="form-control btn-pill commaAmount" id="amount" name="amount"
                                            type="text" value="{{ number_format($income->amount) }}" placeholder="Amount"
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <textarea class="form-control btn-pill" id="description" name="description" placeholder="e.g. Donations" rows="2"
