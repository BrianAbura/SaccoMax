                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">Add Incomes </li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            @endif
                            {{-- Alerts for the home page --}}
                            <form class="row g-3" method="POST" action="{{ route('incomes.store') }}"
                                ...
                                <div class="row mt-3">
                                    <div class="col-md-3">
                                        ...
                                        <div id="otherCategoryInput" class="mt-2 mb-2" style="display: none;">
                                            <input class="form-control btn-pill" name="new_category" type="text" placeholder="Enter category name">
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <label class="form-label" for="amount">Amount</label>
                                        <input class="form-control btn-pill commaAmount" id="amount"
                                            name="amount" type="text" value="{{ old('amount') }}"
                                            placeholder="Amount" aria-label="Amount" required>
                                        @error('amount')
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <textarea class="form-control btn-pill" id="description" name="description" placeholder="e.g. Donations"
                                    ...
                                    <div class="col-md-2">
                                        <label class="form-label" for="exampleFormControlInput1">Date Received</label>
                                        <input class="form-control digits" type="date" name="date_received">
                                        @error('date_received')
                                            <div class="form-text text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
