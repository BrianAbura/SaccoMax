                            ...
                            <a href="{{ route('incomes.index') }}">
                                <div class="card o-hidden small-widget">
                                    <div class="card-body total-upcoming border-b-success border-2"><span
                                            class="f-light f-w-500 f-14">Total Income Received
                                            <div class="project-details">
                                                <div class="project-counter">
                                                    <h3 class="f-w-600">UGX {{ number_format($incomes) }}
                                                    </h3>
                                                </div>
                                                <div class="product-sub bg-success-light">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30"
                    ...
                    <div class="row">
                        <div class="col-xl-3 col-sm-6">
                            <a href="{{ route('expenses.index') }}">
                                <div class="card o-hidden small-widget">
                                    <div class="card-body total-upcoming border-b-info border-2"><span
