                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">Edit Withdrawal </li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            @endif
                            {{-- Alerts for the home page --}}
                            <form class="row g-3" method="POST" action="{{ route('withdrawals.update', $withdrawal->id) }}"
                                ...
                                <div class="row mt-3">
                                    <div class="col-md-3">
                                        ...
                                        <select class="form-select btn-pill" id="validationDefault04" name="member_id">
                                            <option value="{{ $withdrawal->member->id }}">
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <input class="form-control btn-pill commaAmount" id="amount_withdrawn"
                                            name="amount_withdrawn" type="text"
                                            value="{{ number_format($withdrawal->amount) }}" placeholder="Amount Withdrawn"
                                            aria-label="Amount Withdrawn" required>
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <textarea class="form-control btn-pill" id="withdrawal_narration" name="withdrawal_narration"
                                            placeholder="Withdrawal Narration" rows="2" required>{{ $withdrawal->narration }}</textarea>
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <input class="form-control btn-pill commaAmount" id="charges" name="charges"
                                            type="text" value="{{ number_format($withdrawal->charges) }}" placeholder="Charges"
                                            aria-label="Charges" required>
                                        @error('charges')
                                            <div class="form-text text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-12">
                                    ...
                                    <a href="{{ route('withdrawals.show', $withdrawal->member->id) }}"
