                ...
                <div class="col-sm-12">
                    ...
                    <div class="card">
                        ...
                        <div class="d-flex justify-content-end align-items-center">
                            ...
                            <a href="{{ route('savings.create') }}" class="btn btn-primary m-3">Add Savings</a>
                        </div>
                                        ...
                                        @foreach ($savings as $saving)
                                            <tr>
                                                <td class="text-primary text-center"><a class="text-primary "
                                                        href="{{ route('members.show', $saving->member->id) }}">{{ $saving->member->membership_number }}</a>
                                                </td>
                                                <td class="h6 text-primary">
                                                    <a class="text-primary "
                                                        href="{{ route('members.show', $saving->member->id) }}">{{ $saving->member->first_name . ' ' . $saving->member->last_name }}</a>
                                                </td>
                                                <td class="f-w-600 txt-success">UGX
                                                    {{ number_format($saving->total_amount) }}</td>
