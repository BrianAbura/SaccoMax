                            ...
                            <div class="info">
                                ...
                                <div class="row">
                                    ...
                                    @if ($member->status == 0)
                                        <div class="col-md-2">
                                            <div class="ttl-info text-start">
                                                <h6 class="mb-2"><i class="fa fa-calendar"></i>   Deactivated Date</h6>
                                                <span
                                                    class="txt-info">{{ date('d-m-Y H:i', strtotime($member->updated_at)) }}</span>
                                            </div>
                                        </div>
                                    @endif
                                </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="tab-content" id="pills-tabContent">
                                        ...
                                        <div class="card-body">
                                            <div class="text-end mb-3">
                                                <button class="btn btn-info" data-bs-toggle="modal"
                                                    ...
                                                    <i class="fa fa-plus"></i> Add Next of Kin
                                                </button>
                                            </div>
                                            <div class="table-responsive custom-scrollbar">
                                                <table class="display basic-1">
                                                    ...
                                                    <tbody>
                                                        @foreach ($next_of_kins as $next_of_kin)
                                                                ...
                                                                <td>
                                                                    <ul class="action">
                                                                        <li class="edit" data-bs-toggle="modal"
                                                                            data-bs-target="#editNextOfKinModal{{ $next_of_kin->id }}">
                                                                            <i class="icon-pencil-alt"></i>
                                                                        </li>
                                                                        <li class="delete" data-bs-toggle="modal"
                                                                            data-bs-target="#deleteNextOfKinModal{{ $next_of_kin->id }}">
                                                            ...
                                                            <div class="modal fade"
                                                                id="editNextOfKinModal{{ $next_of_kin->id }}"
                                                                tabindex="-1"
                                                                aria-labelledby="editNextOfKinModalLabel{{ $next_of_kin->id }}"
                                                                aria-hidden="true">
                                                                <div class="modal-dialog modal-dialog-centered">
                                                                    <div class="modal-content">
                                                                        <div class="modal-header">
                                                                            <h5 class="modal-title"
                                                                                id="editNextOfKinModalLabel{{ $next_of_kin->id }}">
                                                                                Edit Next of Kin
                                                                            </h5>
                                                                            <button type="button" class="btn-close"
                                                                                data-bs-dismiss="modal"
                                                                        ...
                                                                        <form
                                                                            action="{{ route('next-of-kin.update', $next_of_kin->id) }}"
                                                                            method="POST">
                                                                            @csrf
                                                                            @method('PUT')
                                                                            <div class="modal-body">
                                                                                ...
                                                                                <div class="mb-3">
                                                                                    ...
                                                                                    <input type="tel" pattern="[0-9]*"
                                                                                        ...
                                                                                        class="form-control"
                                                                                        name="phone_number"
                                                                                        value="{{ $next_of_kin->phone_number }}"
                                                                                        required>
                                                                                </div>
                                                                                <div class="mb-3">
                                                                                    ...
                                                                                    <input type="email"
                                                                                        ...
                                                                                        name="email"
                                                                                        value="{{ $next_of_kin->email }}">
                                                                                </div>
                                                                                <div class="mb-3">
                                                                                    <label
                                                                                        class="form-label">Address</label>
                                                                                    <textarea class="form-control" name="address" rows="2" required>{{ $next_of_kin->address }}</textarea>
                                                                                </div>
                                                                            </div>
                                                                            <div class="modal-footer">
                                                                                <button type="button"
                                                            ...
                                                            <div class="modal fade"
                                                                id="deleteNextOfKinModal{{ $next_of_kin->id }}"
                                                                tabindex="-1"
                                                                aria-labelledby="deleteNextOfKinModalLabel{{ $next_of_kin->id }}"
                                                                aria-hidden="true">
                                                                <div class="modal-dialog modal-dialog-centered">
                                                                    <div class="modal-content">
                                                                        <div class="modal-header">
                                                                            <h5 class="modal-title"
                                                                                id="deleteNextOfKinModalLabel{{ $next_of_kin->id }}">
                                                                                Delete Next of Kin
                                                                            </h5>
                                                                            <button type="button" class="btn-close"
                                                                                data-bs-dismiss="modal"
                                                                        ...
                                                                        <div class="modal-body">
                                                                            <p>Are you sure you want to delete this next of
                                                                                kin? This action cannot be undone.</p>
                                                                        </div>
                                                                        <div class="modal-footer">
                                                                            <button type="button" class="btn btn-light"
                                                                                data-bs-dismiss="modal">Cancel</button>
                                                                            <form
                                                                                action="{{ route('next-of-kin.destroy', $next_of_kin->id) }}"
                                    ...
                                    <div class="modal fade" id="addNextOfKinModal" tabindex="-1"
                                        aria-labelledby="addNextOfKinModalLabel" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="addNextOfKinModalLabel">Add Next of Kin
                                                    </h5>
                                                ...
                                                <form action="{{ route('next-of-kin.store') }}" method="POST">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="tel" class="form-control" type="tel"
                                                                pattern="[0-9]*" maxlength="12"
                                                                onkeypress="return (event.charCode >= 48 && event.charCode <= 57)"
                                                                oninput="this.value = this.value.replace(/[^0-9]/g, '')"
                                                                placeholder="256xxxxxxxxx" aria-label="Phone Number"
                                                                name="phone_number" required>
                                                        </div>
                                                        <div class="mb-3">
                                                            <label class="form-label">Email</label>
                                                            <input type="email" class="form-control"
                                                                placeholder="abd@abc.com" name="email">
                                                        </div>
                                                        <div class="mb-3">
