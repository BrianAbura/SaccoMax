                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">Add New Member </li>
                        </ol>
                    </div>
                </div>
            </div>
                                ...
                                <div class="row mt-3">
                                    <div class="col-md-2">
                                        ...
                                        <input class="form-control btn-pill" id="membership-number" name="membership_number"
                                            value="{{ old('membership_number') }}" type="text" placeholder="xxxx/xx/xx"
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input class="form-control btn-pill" id="first-name" name="first_name"
                                            value="{{ old('first_name') }}" type="text" placeholder="First Name"
                                            pattern="[A-Za-z ]*"
                                ...
                                <div class="row mt-4">
                                    <div class="col-md-2">
                                        ...
                                        <input class="form-control btn-pill" id="phone-number" name="phone_number"
                                            ...
                                            placeholder="256xxxxxxxxx" aria-label="Phone Number" required
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input class="form-control btn-pill" id="exampleFormControlInput1"
                                            name="email_address" type="email" placeholder="abc@abc.com" required
                                    ...
                                    <div class="col-md-3">
                                        <label class="form-label" for="exampleFormControlTextarea1">Physical
                                            Address</label>
                                        <textarea class="form-control btn-pill" id="exampleFormControlTextarea1" name="physical_address" rows="2">{{ old('physical_address') }}</textarea>
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <input class="form-control btn-pill" id="employer-name" name="employers_name"
                                            pattern="[A-Za-z ]*"
                                            onkeypress="return (event.charCode > 64 && event.charCode < 91) || (event.charCode > 96 && event.charCode < 123) || (event.charCode==32)"
                                            oninput="this.value = this.value.replace(/[^A-Za-z ]/g, '')" type="text"
                                            placeholder="Employer Name" aria-label="Employer name"
                                            value="{{ old('employers_name') }}">
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <input class="form-control btn-pill" id="employer-number" name="employers_number"
                                            value="{{ old('employers_number') }}" type="tel" pattern="[0-9]*"
                                            maxlength="12"
                                            onkeypress="return (event.charCode >= 48 && event.charCode <= 57)"
                                            oninput="this.value = this.value.replace(/[^0-9]/g, '')"
                                            placeholder="256xxxxxxxxx" aria-label="Employer Number">
                                        @error('employers_number')
                                            <div class="form-text text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                </div>
