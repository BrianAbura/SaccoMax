                        ...
                        <div class="card-header">
                            <h5 class="m-b-0 text-primary">
                                <strong>{{ $member->first_name . ' ' . $member->last_name }} -
                                    ...
                                    <span class="txt-primary">Shareholding Value: <strong>UGX {{ number_format($total_shares) }}</strong></span>

                                <a href="{{ route('shares.index') }}"><i
                                    ...
                                    <tbody>
                                        @foreach ($shares as $share)
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-success">UGX {{ number_format($share->share_number * $share->share_amount) }}</td>
                                                ...
                                                <td>
                                                    <ul class="action">
                                                        <li class="edit"> <a
                                                                href="{{ route('shares.edit', $share->id) }}"><i
