                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">Add Shares </li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            @endif
                            {{-- Alerts for the home page --}}
                            <form class="row g-3" method="POST" action="{{ route('shares.store') }}"
                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <input class="form-control btn-pill commaAmount" id="number_of_shares"
                                            name="number_of_shares" type="text" value="{{ old('number_of_shares') }}"
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <input class="form-control btn-pill commaAmount" id="share_price" name="share_price"
                                            type="text" value="{{ old('share_price') }}" placeholder="Share Price"
                                            aria-label="Share Price" required>
                                        @error('share_price')
                                            <div class="form-text text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
