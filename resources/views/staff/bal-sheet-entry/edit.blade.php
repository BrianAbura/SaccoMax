    ...
    <div class="page-body">
        <div class="container-fluid">
            <div class="page-title">
                <div class="row">
                    <div class="col-6">
                        <h4>Edit Balance Sheet Entry</h4>
                    </div>
                    <div class="col-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">Edit Balance Sheet Entry </li>
                        </ol>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form class="row g-3" method="POST"
                                action="{{ route('balance-sheet-entires.update', $entry->id) }}"
                                ...
                                <div class="row mt-3">
                                    <div class="col-md-3">
                                        ...
                                        <select class="form-select btn-pill" id="categorySelect" name="category" required>
                                            ...
                                            <option value="Liabilities" {{ $entry->category == 'Liabilities' ? 'selected' : '' }}>Liabilities</option>
                                            <option value="Equity" {{ $entry->category == 'Equity' ? 'selected' : '' }}>Equity</option>
                                        </select>
                                        @error('category')
                                        ...
                                        <select class="form-select btn-pill" id="subcategorySelect" name="sub_category_id"
                                            ...
                                            @foreach ($sub_categories as $sub_category)
                                                <option value="{{ $sub_category->id }}"
                                                    {{ $sub_category->id == $entry->balance_sheet_sub_categories_id ? 'selected' : '' }}>
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <textarea class="form-control btn-pill" id="item_description" name="item_description" rows="2" required>{{ $entry->item_description }}</textarea>
                                ...
                                <div class="row mt-3">
                                    <div class="col-md-2">
                                        ...
                                        <input class="form-control btn-pill commaAmount" id="amount" name="amount"
                                            type="text" value="{{ $entry->item_value }}" placeholder="Amount"
                                    ...
                                    <div class="col-md-3 mb-2">
                                        ...
                                        @if (!empty($entry->attachment))
                                            <a href="#" class="open-modal" data-bs-toggle="modal"
                                                ...
                                                data-image="{{ asset($entry->attachment) }}">
                                                <img class="b-r-10" src="{{ asset($entry->attachment) }}"
                                                    width="60px">
                                            </a>
                                        @else
