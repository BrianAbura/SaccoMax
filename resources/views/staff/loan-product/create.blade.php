                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">Create Loan Product </li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            @endif
                            {{-- Alerts for the home page --}}
                            <form class="row g-3" method="POST" action="{{ route('loan-product.store') }}"
                                enctype="multipart/form-data">
                                @csrf
                                <div class="row mt-3">
                                    <div class="col-md-3">
                                        <label class="form-label" for="amount-saved">Loan Type</label>
                                        <textarea class="form-control btn-pill" id="loan_type" name="loan_type" rows="2" required>{{ old('loan_type') }}</textarea>
                                        @error('loan_type')
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input class="form-control btn-pill commaAmount" id="max_loan_amount"
                                            name="max_loan_amount" type="text" value="{{ old('max_loan_amount') }}"
                                            required>
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <input class="form-control btn-pill commaAmount" id="loan_period" name="loan_period"
                                            type="number" max="100" value="{{ old('loan_period') }}" required>
                                        @error('loan_period')
                                            <div class="form-text text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <input class="form-control btn-pill commaAmount" id="annual_interest_rate"
                                            ...
                                            value="{{ old('annual_interest_rate') }}" required>
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <input class="form-control btn-pill commaAmount" id="grace_period" name="grace_period"
                                            type="number" value="{{ old('grace_period') }}">
                                        @error('grace_period')
                                            <div class="form-text text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
