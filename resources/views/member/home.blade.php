                        ...
                        <div class="col-xl-4 col-sm-6">
                            <div class="card o-hidden small-widget">
                                <div class="card-body total-Complete border-b-warning border-2"><span
                                        class="f-light f-w-500 f-14">Membership Fees
                                    </span>
                                    <div class="project-details">
                                        <div class="project-counter">
                                            <h2 class="f-w-600">UGX {{ number_format($membership_fees) }}
                                            </h2>
                                        </div>
                                        <div class="product-sub bg-warning-light">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30"
                        ...
                        <div class="col-xl-4 col-sm-6">
                            <div class="card o-hidden small-widget">
                                <div class="card-body total-Complete border-b-primary border-2"><span
                                        class="f-light f-w-500 f-14">Annual Fees
                                    </span>
                                    <div class="project-details">
                                        <div class="project-counter">
                                            <h2 class="f-w-600">UGX {{ number_format($annual_fees) }}
                                            </h2>
                                        </div>
                                        <div class="product-sub bg-primary-light">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30"
